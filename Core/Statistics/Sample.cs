...
namespace Meta.Numerics.Statistics {
    ...
    public sealed class Sample : ICollection<double>, IEnumerable<double>, IEnumerable {
        ...
        /// all groups considered together as one single sample to the variances of the groups
        ...
        /// individual groups, and the test will signal a significant difference. Thus the
