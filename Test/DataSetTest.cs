...
namespace Test {
    ...
    public class DataSetTest {
        ...
        private DataSet CreateDataSet (Interval r, Function<double, double> fv, Function<double, double> fu, int n) {
            return (CreateDataSet(r, fv, fu, n, 1));
        }


        private DataSet CreateDataSet (Interval r, Function<double, double> fv, Function<double, double> fu, int n, int seed) {
            DataSet set = new DataSet();
            ...
            for (int i = 0; i < n; i++) {
                ...
                DataPoint point = new DataPoint(x, y, ys);
                set.Add(point);
        ...
        private DataSet CreateDataSet (double[] xs, Function<double, double> fv, Function<double, double> fu, int seed) {
            DataSet set = new DataSet();
            Random rng = new Random(seed);
        ...
        public void FitDataToProportionalityTest () {
            ...
            DataSet set = CreateDataSet(r, fv, fu, 20);
        ...
        public void FitDataToLineTest () {
            ...
            DataSet data = CreateDataSet(r, fv, fu, 20);
        ...
        public void FitDataToLineChiSquaredTest () {
            ...
            for (int i = 0; i < 50; i++) {
                DataSet xs = CreateDataSet(r, fv, fu, 10, i);
        ...
        public void FitDataToPolynomialTest () {
            ...
            DataSet set = CreateDataSet(r, fv, fu, 50);
        ...
        public void FitDataToLinearFunctionTest () {
            ...
            Function<double,double>[] fs = new Function<double,double>[]
        ...
        public void FitDataToFunctionTest () {
            ...
            */
            ...
            DataSet set = new DataSet();
            set.Add(new DataPoint(1.0,  1.0, 0.1));
            set.Add(new DataPoint(2.0,  0.7, 0.1));
            set.Add(new DataPoint(3.0,  0.0, 0.1));
            set.Add(new DataPoint(4.0, -0.7, 0.1));
            set.Add(new DataPoint(5.0, -1.0, 0.1));
            set.Add(new DataPoint(6.0, -0.7, 0.1));
            set.Add(new DataPoint(7.0,  0.0, 0.1));
            set.Add(new DataPoint(8.0,  0.7, 0.1));
            set.Add(new DataPoint(9.0,  1.0, 0.1));
        ...
        public void FitToFunctionLinearCompatibilityTest () {
            ...
            DataSet set = CreateDataSet(r, fv, fu, 30);
        ...
        public void FitToFunctionPolynomialCompatibilityTest () {
            ...
            // create a data set from it
            DataSet set = CreateDataSet(r, fv, fu, 60);
