...
namespace Meta.Numerics.Statistics {
    ...
    /// </para>
    /// <para>The central class for operating on samples of independent, simple data points is the
    ...
    /// for operating on samples of independent collections of multiple values is the <see cref="Multivariate"/>
    ...
    /// users to transfer the data into our containers before it can be analyzed. You can still
